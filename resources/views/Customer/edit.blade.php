                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Customer Management</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="/customers">Customer Listing</a></li>
                                    ...
                                    <form action="/customers/{{ $customer->id }}" method="POST">
                                        ...
                                        <div class="form-group d-flex justify-content-center">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="phoneNo" value="{{ $customer->phone_no }}" placeholder="Eg: 0123456789" maxlength="11" required>
                                                @error('phoneNo')
                                                    <div class="mt-2">
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    </div>
