...
<head>
    <meta charset="utf-8" />
    <title>Login - YTA Admin & Dashboard</title>
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        <h5 class="text-primary">Welcome Back, Sir!</h5>
                                        <p>Sign in to proceed with admin.</p>
                                    </div>
                                </div>
                                <div class="col-5 align-self-end">
                                    <img src="{{ asset('assets/images/logo.png') }}" alt="" class="img-fluid" style="background-color: #314594; padding-top: 30px">
                                </div>
                            </div>
                        </div>
